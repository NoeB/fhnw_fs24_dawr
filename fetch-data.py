...
files: List[File] = [
    {'url': 'https://www.web.statistik.zh.ch/ogd/data/KANTON_ZUERICH_141.csv', 'output_file_name': 'Berufsschueler.csv', 'source': 'https://www.zh.ch/de/politik-staat/statistik-daten/datenkatalog.html#/datasets/39@statistisches-amt-kanton-zuerich'},
    {'url': 'https://www.web.statistik.zh.ch/ogd/daten/ressourcen/KTZH_00002042_00004083.csv', 'output_file_name': 'Einrüche.csv', 'source': 'https://www.zh.ch/de/politik-staat/statistik-daten/datenkatalog.html#/datasets/2042@kantonspolizei-kanton-zuerich'},
    ...
    {'url': 'https://www.web.statistik.zh.ch/ogd/data/KANTON_ZUERICH_133.csv', 'output_file_name':'Bevökerung.csv', 'source': 'https://www.zh.ch/de/politik-staat/statistik-daten/datenkatalog.html#/datasets/204@statistisches-amt-kanton-zuerich'},
...
for file in files:
    fetch.download_file_from_url(file['url'], data_path + '/raw', file['output_file_name'])
...
scrape.scrape_table_to_csv('https://www.agvchapp.bfs.admin.ch/de/communes/results?EntriesFrom=01.01.2021&EntriesTo=31.12.2021&Canton=ZH', data_path + '/raw', 'gemeinde.csv')
#https://www.agvchapp.bfs.admin.ch/de/communes/results?EntriesFrom=01.01.2021&EntriesTo=30.12.2021&Canton=ZH